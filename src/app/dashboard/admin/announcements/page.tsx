...
import { announcements, classLists } from "@/lib/data";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Create and view announcements for students and faculty.</p>
        </div>
          ...
          <DialogContent className="sm:max-w-[525px]">
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="title" className="col-span-3" placeholder="e.g. Upcoming School Holiday"/>
              </div>
