...
export default function HighSchoolCourseSelectionPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold font-headline">High School Course Selection</h1>
                             ...
                             <div key={choice}>
                              ...
                              <Select>
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="none">Study Block</SelectItem>
                                </SelectContent>
                              </Select>
                            </div>
                          ))}
